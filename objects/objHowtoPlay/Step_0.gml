...
if (menuX > guiWidth+150) && (menuCommitted != -1)
{
	switch (menuCommitted)
	{
		...
		case 2: default: room_goto(rmLevel2Medium); break;
		case 1: default: room_goto(rmLevel1Tutorial); break;
